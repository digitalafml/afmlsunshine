...
import akijFlourMillsLogo from "@/assets/akij-flour-mills-footer-logo.png";
import akijInsafLogo from "@/assets/akij-insaf-logo.png";

const Footer = () => {
  return (
    <footer id="contact" className="bg-akij-red text-secondary-foreground relative overflow-hidden">
      {/* Decorative Elements - matching Quality Section */}
      <motion.div 
      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        ...
        >
          ...
          <div className="lg:col-span-1">
            <img src={akijFlourMillsLogo} alt="Akij Flour Mills Ltd." className="h-14 w-auto mb-4" />
                ...
                (item, index) => (
                  ...
                  >
                    <a
                      ...
                      className="text-secondary-foreground/80 hover:text-secondary-foreground transition-colors text-sm inline-block hover:translate-x-1 duration-200"
                    >
                      {item}
                    </a>
                  </motion.li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              >
                <MapPin size={18} className="text-secondary-foreground mt-0.5 shrink-0" />
              ...
              >
                <Phone size={18} className="text-secondary-foreground shrink-0" />
                <a
              ...
              >
                <Mail size={18} className="text-secondary-foreground shrink-0" />
                <a
        ...
        {/* Bottom Bar */}
        <motion.div 
          className="mt-12 pt-8 border-t border-secondary-foreground/20 flex flex-col md:flex-row justify-between items-center gap-4"
          initial={{ opacity: 0 }}
